"""
SIRIUS LOCAL AI – Reasoning Graph Builder 4.5.0 (PRO)

Deterministic graph builder for Reasoning Engine 4.5.
...
class ReasoningGraphBuilder45:
    ...
    def build_graph(self, query: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.safe_mode:
            return {
                "status": "safe_mode",
                "message": "Graph builder disabled in safe-mode.",
                "version": "4.5",
            }
