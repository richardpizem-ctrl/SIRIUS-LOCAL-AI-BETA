...
4. 🛡 Identity Enforcement (Security Family 4.4)
Password Vault strictly follows identity rules:

Identity	Permissions
OWNER	full read/write/delete
FAMILY	read‑only
STRANGER	denied All access is routed through:
...
System Agent 4.2 (NEW enforcement layer)
...
All tasks enforce identity and capability boundaries. 7. 📁 File Location
Vault file is stored locally: /sirius_data/vault/password_vault.json.enc
encrypted
